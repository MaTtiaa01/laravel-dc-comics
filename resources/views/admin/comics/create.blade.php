...
<div class="container py-5">
    ...
    <form action="{{route('comics.store')}}" method="post" class="card p-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="title" id="title" class="form-control" placeholder="Title" aria-describedby="helpId" value="{{old('title')}}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="thumb" id="thumb" class="form-control" placeholder="thumb" aria-describedby="helpId" value="{{old('thumb')}}">
        </div>
        <div class="mb-3">
